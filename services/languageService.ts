...
export const translations: Record<Language, TranslationSet> = {
  vi: {
    ...
    securitySubtitle: "XÁC THỰC QUYỀN TRUY CẬP TRANG QUAY",
    securityLabel: "MẬT KHẨU MC ĐIỀU KHIỂN HOẶC ADMIN",
    securityPlaceholder: "Nhập mật khẩu (MC: hannn13 | Admin: hannn2)...",
